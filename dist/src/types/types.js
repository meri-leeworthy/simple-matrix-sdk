...
exports.CreateRoomOptsSchema = exports.ClientEventWithUnsignedSchema = exports.UnsignedDataSchema = exports.UnsignedDataBaseSchema = exports.SpecRoomEventTypeSchema = exports.RoomMessageTypeSchema = exports.ThumbnailInfoSchema = void 0;
...
// 'redacted_because' ClientEvent should not contain another unsigned field
exports.UnsignedDataBaseSchema = z
    .object({
    ...
    "m.relations": z.record(z.string(), z.union([z.object({}), z.array(z.object({}))])),
})
    .partial();
exports.UnsignedDataSchema = exports.UnsignedDataBaseSchema.extend({
    redacted_because: z.lazy(() => event_1.ClientEventBaseSchema),
});
exports.ClientEventWithUnsignedSchema = event_1.ClientEventBaseSchema.extend({
    unsigned: exports.UnsignedDataSchema,
});
...
//     })
//     .merge(ClientEventWithUnsignedSchema),
//   z
//     .object({
//       type: z.string({ invalid_type_error: "Event type must be a string" }),
//       content: z.unknown(),
...
//       content: z.object({
//         url: z.optional(
//           z.string({ invalid_type_error: "URL must be a string" })
//         ),
//       }),
//     })
//     .merge(ClientEventWithUnsignedSchema),
...
//       content: z.object({
//         aliases: z.array(
//           z.string({ invalid_type_error: "Alias must be a string" })
//         ),
//       }),
//     })
//     .merge(ClientEventWithUnsignedSchema),
